...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter username", placeholder="Enter your username", key="teacher_username")
    teacher_password = st.text_input("Enter password", placeholder="Enter your password", type="password", key="teacher_password")
...
def register_teacher(teacher_username,teacher_name,teacher_password,teacher_password_confirm):
    ...
    if teacher_password!= teacher_password_confirm:
        return False,"Password doesm't match"
